...
/*
 * Auto generated by u8glib-po-to-c-font.
 */
...
const int %(font_varaint_name)sEncodingCount = sizeof(%(font_varaint_name)s) / sizeof(%(font_varaint_name)s[0])
    ...
    header_file = open(header_file_path, "wb")
    header_file.write(six.b("""
    
#ifndef __%(header_file_uppercase_name)s_INCLUDED_%(uuid_value)s
#define __%(header_file_uppercase_name)s_INCLUDED_%(uuid_value)s

/*
 * Auto generated by u8gettext-gen-data.
 */
...
extern const u8g_fntpgm_uint8_t %(font_varaint_name)s[];
const int %(font_varaint_name)sEncodingCount;

#ifdef __cplusplus
};
#endif

#endif /* #ifndef __%(header_file_uppercase_name)s_INCLUDED_%(uuid_value)s */

    """ % {"font_varaint_name":font_varaint_name, 
        "header_file_uppercase_name":header_file_name.replace(".", "_").upper(), 
        "uuid_value":uuid.uuid1().hex.upper(), 
        })
    )
    header_file.close()
